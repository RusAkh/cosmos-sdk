...
var (
	...
	fd_Proposal_is_expedited       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Proposal_is_expedited = md_Proposal.Fields().ByName("is_expedited")
}
...
func (x *fastReflection_Proposal) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.IsExpedited != false {
		value := protoreflect.ValueOfBool(x.IsExpedited)
		if !f(fd_Proposal_is_expedited, value) {
			return
		}
	}
}
...
func (x *fastReflection_Proposal) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.gov.v1beta1.Proposal.is_expedited":
		return x.IsExpedited != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Proposal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.Proposal.is_expedited":
		panic(fmt.Errorf("field is_expedited of message cosmos.gov.v1beta1.Proposal is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1beta1.Proposal"))
		}
...
func (x *fastReflection_Proposal) ProtoMethods() *protoiface.Methods {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 10:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field IsExpedited", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
var _ protoreflect.List = (*_DepositParams_3_list)(nil)

type _DepositParams_3_list struct {
	list *[]*v1beta1.Coin
}

func (x *_DepositParams_3_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_DepositParams_3_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_DepositParams_3_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_DepositParams_3_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_DepositParams_3_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_DepositParams_3_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_DepositParams_3_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_DepositParams_3_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_DepositParams_min_expedited_deposit     protoreflect.FieldDescriptor
...
func init() {
	...
	fd_DepositParams_min_expedited_deposit = md_DepositParams.Fields().ByName("min_expedited_deposit")
...
func (x *fastReflection_DepositParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.MinExpeditedDeposit) != 0 {
		value := protoreflect.ValueOfList(&_DepositParams_3_list{list: &x.MinExpeditedDeposit})
		if !f(fd_DepositParams_min_expedited_deposit, value) {
			return
		}
	}
...
func (x *fastReflection_DepositParams) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.gov.v1beta1.DepositParams.min_expedited_deposit":
		return len(x.MinExpeditedDeposit) != 0
	case "cosmos.gov.v1beta1.DepositParams.min_initial_deposit_ratio":
...
func (x *fastReflection_DepositParams) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.DepositParams.min_expedited_deposit":
		if len(x.MinExpeditedDeposit) == 0 {
			return protoreflect.ValueOfList(&_DepositParams_3_list{})
		}
		listValue := &_DepositParams_3_list{list: &x.MinExpeditedDeposit}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.gov.v1beta1.DepositParams.min_initial_deposit_ratio":
...
func (x *fastReflection_DepositParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.gov.v1beta1.DepositParams.min_expedited_deposit":
		lv := value.List()
		clv := lv.(*_DepositParams_3_list)
		x.MinExpeditedDeposit = *clv.list
	case "cosmos.gov.v1beta1.DepositParams.min_initial_deposit_ratio":
...
func (x *fastReflection_DepositParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.DepositParams.min_expedited_deposit":
		if x.MinExpeditedDeposit == nil {
			x.MinExpeditedDeposit = []*v1beta1.Coin{}
		}
		value := &_DepositParams_3_list{list: &x.MinExpeditedDeposit}
		return protoreflect.ValueOfList(value)
	case "cosmos.gov.v1beta1.DepositParams.min_initial_deposit_ratio":
		panic(fmt.Errorf("field min_initial_deposit_ratio of message cosmos.gov.v1beta1.DepositParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1beta1.DepositParams"))
		}
...
func (x *fastReflection_DepositParams) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.DepositParams.min_expedited_deposit":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_DepositParams_3_list{list: &list})
	case "cosmos.gov.v1beta1.DepositParams.min_initial_deposit_ratio":
		return protoreflect.ValueOfString("")
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_DepositParams) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.MinExpeditedDeposit) > 0 {
			for _, e := range x.MinExpeditedDeposit {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.MinExpeditedDeposit) > 0 {
			for iNdEx := len(x.MinExpeditedDeposit) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.MinExpeditedDeposit[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MinExpeditedDeposit", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.MinExpeditedDeposit = append(x.MinExpeditedDeposit, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.MinExpeditedDeposit[len(x.MinExpeditedDeposit)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 4:
...
var _ protoreflect.List = (*_VotingParams_2_list)(nil)

type _VotingParams_2_list struct {
	list *[]*ProposalVotingPeriod
}

func (x *_VotingParams_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_VotingParams_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_VotingParams_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ProposalVotingPeriod)
	(*x.list)[i] = concreteValue
}

func (x *_VotingParams_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ProposalVotingPeriod)
	*x.list = append(*x.list, concreteValue)
}

func (x *_VotingParams_2_list) AppendMutable() protoreflect.Value {
	v := new(ProposalVotingPeriod)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_VotingParams_2_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_VotingParams_2_list) NewElement() protoreflect.Value {
	v := new(ProposalVotingPeriod)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_VotingParams_2_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_VotingParams_proposal_voting_periods protoreflect.FieldDescriptor
	fd_VotingParams_expedited_voting_period protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_VotingParams_proposal_voting_periods = md_VotingParams.Fields().ByName("proposal_voting_periods")
	fd_VotingParams_expedited_voting_period = md_VotingParams.Fields().ByName("expedited_voting_period")
}
...
func (x *fastReflection_VotingParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ProposalVotingPeriods) != 0 {
		value := protoreflect.ValueOfList(&_VotingParams_2_list{list: &x.ProposalVotingPeriods})
		if !f(fd_VotingParams_proposal_voting_periods, value) {
			return
		}
	}
	if x.ExpeditedVotingPeriod != nil {
		value := protoreflect.ValueOfMessage(x.ExpeditedVotingPeriod.ProtoReflect())
		if !f(fd_VotingParams_expedited_voting_period, value) {
			return
		}
	}
}
...
func (x *fastReflection_VotingParams) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.gov.v1beta1.VotingParams.proposal_voting_periods":
		return len(x.ProposalVotingPeriods) != 0
	case "cosmos.gov.v1beta1.VotingParams.expedited_voting_period":
...
func (x *fastReflection_VotingParams) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.VotingParams.proposal_voting_periods":
		if len(x.ProposalVotingPeriods) == 0 {
			return protoreflect.ValueOfList(&_VotingParams_2_list{})
		}
		listValue := &_VotingParams_2_list{list: &x.ProposalVotingPeriods}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.gov.v1beta1.VotingParams.expedited_voting_period":
...
func (x *fastReflection_VotingParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.gov.v1beta1.VotingParams.proposal_voting_periods":
		lv := value.List()
		clv := lv.(*_VotingParams_2_list)
		x.ProposalVotingPeriods = *clv.list
	case "cosmos.gov.v1beta1.VotingParams.expedited_voting_period":
...
func (x *fastReflection_VotingParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.VotingParams.proposal_voting_periods":
		if x.ProposalVotingPeriods == nil {
			x.ProposalVotingPeriods = []*ProposalVotingPeriod{}
		}
		value := &_VotingParams_2_list{list: &x.ProposalVotingPeriods}
		return protoreflect.ValueOfList(value)
	case "cosmos.gov.v1beta1.VotingParams.expedited_voting_period":
		if x.ExpeditedVotingPeriod == nil {
...
func (x *fastReflection_VotingParams) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.VotingParams.proposal_voting_periods":
		list := []*ProposalVotingPeriod{}
		return protoreflect.ValueOfList(&_VotingParams_2_list{list: &list})
	case "cosmos.gov.v1beta1.VotingParams.expedited_voting_period":
		m := new(durationpb.Duration)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
...
func (x *fastReflection_VotingParams) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.ProposalVotingPeriods) > 0 {
			for _, e := range x.ProposalVotingPeriods {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ProposalVotingPeriods) > 0 {
			for iNdEx := len(x.ProposalVotingPeriods) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.ProposalVotingPeriods[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ProposalVotingPeriods", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ProposalVotingPeriods = append(x.ProposalVotingPeriods, &ProposalVotingPeriod{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.ProposalVotingPeriods[len(x.ProposalVotingPeriods)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 3:
...
var (
	...
	fd_TallyParams_expedited_threshold protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_TallyParams_expedited_threshold = md_TallyParams.Fields().ByName("expedited_threshold")
}
...
func (x *fastReflection_TallyParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ExpeditedThreshold) != 0 {
		value := protoreflect.ValueOfBytes(x.ExpeditedThreshold)
		if !f(fd_TallyParams_expedited_threshold, value) {
			return
		}
	}
}
...
func (x *fastReflection_TallyParams) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.gov.v1beta1.TallyParams.expedited_threshold":
		return len(x.ExpeditedThreshold) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_TallyParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.gov.v1beta1.TallyParams.expedited_threshold":
		x.ExpeditedThreshold = value.Bytes()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1beta1.TallyParams"))
		}
...
func (x *fastReflection_TallyParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta1.TallyParams.expedited_threshold":
		panic(fmt.Errorf("field expedited_threshold of message cosmos.gov.v1beta1.TallyParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1beta1.TallyParams"))
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				...
				x.ExpeditedThreshold = append(x.ExpeditedThreshold[:0], dAtA[iNdEx:postIndex]...)
				if x.ExpeditedThreshold == nil {
					x.ExpeditedThreshold = []byte{}
				}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
var (
	md_ProposalVotingPeriod               protoreflect.MessageDescriptor
	fd_ProposalVotingPeriod_proposal_type protoreflect.FieldDescriptor
	fd_ProposalVotingPeriod_voting_period protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1beta1_gov_proto_init()
	md_ProposalVotingPeriod = File_cosmos_gov_v1beta1_gov_proto.Messages().ByName("ProposalVotingPeriod")
	fd_ProposalVotingPeriod_proposal_type = md_ProposalVotingPeriod.Fields().ByName("proposal_type")
	fd_ProposalVotingPeriod_voting_period = md_ProposalVotingPeriod.Fields().ByName("voting_period")
}

var _ protoreflect.Message = (*fastReflection_ProposalVotingPeriod)(nil)

type fastReflection_ProposalVotingPeriod ProposalVotingPeriod

func (x *ProposalVotingPeriod) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ProposalVotingPeriod)(x)
}

func (x *ProposalVotingPeriod) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ProposalVotingPeriod_messageType fastReflection_ProposalVotingPeriod_messageType
var _ protoreflect.MessageType = fastReflection_ProposalVotingPeriod_messageType{}

type fastReflection_ProposalVotingPeriod_messageType struct{}

func (x fastReflection_ProposalVotingPeriod_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ProposalVotingPeriod)(nil)
}
func (x fastReflection_ProposalVotingPeriod_messageType) New() protoreflect.Message {
	return new(fastReflection_ProposalVotingPeriod)
}
func (x fastReflection_ProposalVotingPeriod_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalVotingPeriod
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ProposalVotingPeriod) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalVotingPeriod
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ProposalVotingPeriod) Type() protoreflect.MessageType {
	return _fastReflection_ProposalVotingPeriod_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ProposalVotingPeriod) New() protoreflect.Message {
	return new(fastReflection_ProposalVotingPeriod)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ProposalVotingPeriod) Interface() protoreflect.ProtoMessage {
	return (*ProposalVotingPeriod)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ProposalVotingPeriod) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ProposalType != "" {
		value := protoreflect.ValueOfString(x.ProposalType)
		if !f(fd_ProposalVotingPeriod_proposal_type, value) {
			return
		}
	}
	if x.VotingPeriod != nil {
		value := protoreflect.ValueOfMessage(x.VotingPeriod.ProtoReflect())
		if !f(fd_ProposalVotingPeriod_voting_period, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ProposalVotingPeriod) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.proposal_type":
		return x.ProposalType != ""
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.voting_period":
		return x.VotingPeriod != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1beta1.ProposalVotingPeriod"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1beta1.ProposalVotingPeriod does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalVotingPeriod) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.proposal_type":
		x.ProposalType = ""
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.voting_period":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ProposalVotingPeriod) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.proposal_type":
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.gov.v1beta1.ProposalVotingPeriod does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalVotingPeriod) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.proposal_type":
		x.ProposalType = value.Interface().(string)
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.voting_period":
		x.VotingPeriod = value.Message().Interface().(*durationpb.Duration)
	default:
		if fd.IsExtension() {
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalVotingPeriod) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.voting_period":
		if x.VotingPeriod == nil {
			x.VotingPeriod = new(durationpb.Duration)
		...
		return protoreflect.ValueOfMessage(x.VotingPeriod.ProtoReflect())
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.proposal_type":
		panic(fmt.Errorf("field proposal_type of message cosmos.gov.v1beta1.ProposalVotingPeriod is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1beta1.ProposalVotingPeriod"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ProposalVotingPeriod) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.proposal_type":
		return protoreflect.ValueOfString("")
	case "cosmos.gov.v1beta1.ProposalVotingPeriod.voting_period":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ProposalVotingPeriod) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1beta1.ProposalVotingPeriod", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ProposalVotingPeriod) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalVotingPeriod) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ProposalVotingPeriod) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ProposalVotingPeriod) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ProposalVotingPeriod)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ProposalType) > 0 {
			i -= len(x.ProposalType)
			copy(dAtA[i:], x.ProposalType)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ProposalType)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalVotingPeriod: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalVotingPeriod: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				x.ProposalType = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field VotingPeriod", wireType)
...
func (x *Proposal) GetIsExpedited() bool {
	if x != nil {
		return x.IsExpedited
	}
	return false
}
...
type DepositParams struct {
	...
	MinExpeditedDeposit []*v1beta1.Coin `protobuf:"bytes,3,rep,name=min_expedited_deposit,json=minExpeditedDeposit,proto3" json:"min_expedited_deposit,omitempty"`
	// The ratio representing the proportion of the deposit value that must be paid at proposal submission.
	MinInitialDepositRatio string `protobuf:"bytes,4,opt,name=min_initial_deposit_ratio,json=minInitialDepositRatio,proto3" json:"min_initial_deposit_ratio,omitempty"`
}
...
func (x *DepositParams) GetMinExpeditedDeposit() []*v1beta1.Coin {
	if x != nil {
		return x.MinExpeditedDeposit
	}
	return nil
}
...
type VotingParams struct {
	...
	ProposalVotingPeriods []*ProposalVotingPeriod `protobuf:"bytes,2,rep,name=proposal_voting_periods,json=proposalVotingPeriods,proto3" json:"proposal_voting_periods,omitempty"`
	// Length of the expedited voting period.
	ExpeditedVotingPeriod *durationpb.Duration `protobuf:"bytes,3,opt,name=expedited_voting_period,json=expeditedVotingPeriod,proto3" json:"expedited_voting_period,omitempty"`
}
...
func (x *VotingParams) GetProposalVotingPeriods() []*ProposalVotingPeriod {
	if x != nil {
		return x.ProposalVotingPeriods
	}
	return nil
}

func (x *VotingParams) GetExpeditedVotingPeriod() *durationpb.Duration {
	if x != nil {
...
type TallyParams struct {
	...
	ExpeditedThreshold []byte `protobuf:"bytes,4,opt,name=expedited_threshold,json=expeditedThreshold,proto3" json:"expedited_threshold,omitempty"`
}
...
func (x *TallyParams) GetExpeditedThreshold() []byte {
	if x != nil {
...
type ProposalVotingPeriod struct {
	...
	ProposalType string               `protobuf:"bytes,1,opt,name=proposal_type,json=proposalType,proto3" json:"proposal_type,omitempty"` // e.g. "cosmos.params.v1beta1.ParameterChangeProposal"
...
func (x *ProposalVotingPeriod) Reset() {
	*x = ProposalVotingPeriod{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_gov_v1beta1_gov_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *ProposalVotingPeriod) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProposalVotingPeriod) ProtoMessage() {}

// Deprecated: Use ProposalVotingPeriod.ProtoReflect.Descriptor instead.
func (*ProposalVotingPeriod) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1beta1_gov_proto_rawDescGZIP(), []int{9}
}

func (x *ProposalVotingPeriod) GetProposalType() string {
	if x != nil {
		return x.ProposalType
	}
	return ""
...
func (x *ProposalVotingPeriod) GetVotingPeriod() *durationpb.Duration {
	if x != nil {
		return x.VotingPeriod
	}
	return nil
...
var file_cosmos_gov_v1beta1_gov_proto_rawDesc = []byte{
	...
	0x1f, 0x00, 0x22, 0x99, 0x07, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x12,
	...
	,
	...
	0x74, 0x52, 0x07, 0x61, 0x62, 0x73, 0x74, 0x61, 0x69, 0x6e, 0x12, 0x3e, 0x0a, 0x02, 0x6e, 0x6f,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2e, 0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x26,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x74, 0x79, 0x70,
	0x65, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x02, 0x6e, 0x6f, 0x12, 0x67, 0x0a, 0x0c, 0x6e, 0x6f,
	...
	0xf2, 0xde, 0x1f, 0x13, 0x79, 0x61, 0x6d, 0x6c, 0x3a, 0x22, 0x6e, 0x6f, 0x5f, 0x77, 0x69, 0x74,
	0x68, 0x5f, 0x76, 0x65, 0x74, 0x6f, 0x22, 0x52, 0x0a, 0x6e, 0x6f, 0x57, 0x69, 0x74, 0x68, 0x56,
	0x65, 0x74, 0x6f, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xe3, 0x01, 0x0a, 0x04, 0x56, 0x6f,
	0x74, 0x65, 0x12, 0x37, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x5f, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x42, 0x16, 0xf2, 0xde, 0x1f, 0x12, 0x79, 0x61, 0x6d,
	0x6c, 0x3a, 0x22, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x22, 0x52,
	...
	0x72, 0x12, 0x3a, 0x0a, 0x06, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x6e, 0x42, 0x02, 0x18, 0x01, 0x52, 0x06, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x46, 0x0a,
	0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26,
	...
	,
	...
	,
	...
	0x6f, 0x64, 0x2c, 0x6f, 0x6d, 0x69, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x79, 0xf2, 0xde, 0x1f, 0x14,
	0x79, 0x61, 0x6d, 0x6c, 0x3a, 0x22, 0x76, 0x6f, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x70, 0x65, 0x72,
	0x69, 0x6f, 0x64, 0x22, 0x98, 0xdf, 0x1f, 0x01, 0x52, 0x0c, 0x76, 0x6f, 0x74, 0x69, 0x6e, 0x67,
	0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x12, 0x66, 0x0a, 0x17, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73,
	0x61, 0x6c, 0x5f, 0x76, 0x6f, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64,
	...
	,
	...
	0x68, 0x6f, 0x6c, 0x64, 0x12, 0x8a, 0x01, 0x0a, 0x0e, 0x76, 0x65, 0x74, 0x6f, 0x5f, 0x74, 0x68,
	0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x63, 0xc8,
	...
	,
...
var file_cosmos_gov_v1beta1_gov_proto_goTypes = []interface{}{
	...
	(*ProposalVotingPeriod)(nil),  // 11: cosmos.gov.v1beta1.ProposalVotingPeriod
...
var file_cosmos_gov_v1beta1_gov_proto_depIdxs = []int32{
	...
	12, // 14: cosmos.gov.v1beta1.DepositParams.min_expedited_deposit:type_name -> cosmos.base.v1beta1.Coin
	15, // 15: cosmos.gov.v1beta1.VotingParams.voting_period:type_name -> google.protobuf.Duration
	11, // 16: cosmos.gov.v1beta1.VotingParams.proposal_voting_periods:type_name -> cosmos.gov.v1beta1.ProposalVotingPeriod
	15, // 17: cosmos.gov.v1beta1.VotingParams.expedited_voting_period:type_name -> google.protobuf.Duration
	15, // 18: cosmos.gov.v1beta1.ProposalVotingPeriod.voting_period:type_name -> google.protobuf.Duration
...
func file_cosmos_gov_v1beta1_gov_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_gov_v1beta1_gov_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProposalVotingPeriod); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
